...
- **injects/**: Contains the transformation infrastructure:
  ...
  - Injection functions that replace Brevitas modules with custom forwards
  - Transform passes that recursively modify model architectures
  - Each pass handles a specific module type (linear, activations, MHA)
